...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [
            [
                InlineKeyboardButton('Hᴏᴡ Tᴏ Uꜱᴇ Mᴇʜ', url=f"https://t.me/{temp.U_NAME}?start=help")
            ]
            ]
        reply_markup=InlineKeyboardMarkup(buttons)
        await message.reply_text(
            text=f"<b>›› ᴛʜᴀɴᴋꜱ ꜰᴏʀ ᴀᴅᴅɪɴɢ ᴍᴇ ᴛᴏ yᴏᴜʀ ɢʀᴏᴜᴩ.\n›› ᴅᴏɴᴛ ꜰᴏʀɢᴇᴛ ᴛᴏ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ.\n›› ɪꜰ yᴏᴜ ʜᴀᴠᴇ ᴀɴy ᴅᴏᴜʙᴛꜱ ɪɴ ᴜꜱɪɴɢ ᴍᴇ ᴄᴏɴᴛᴀᴄᴛ ᴍy ᴀᴅᴍɪɴ ʜᴇ ᴡɪʟʟ ʜᴇʟᴩ yᴏᴜ..⚡⚡.</b>",
            reply_markup=reply_markup)
    else:
...
async def get_ststs(bot, message):
    rju = await message.reply('<b>Cʜᴇᴄᴋɪɴɢ Sᴛᴀᴛᴜꜱ...</b>')
